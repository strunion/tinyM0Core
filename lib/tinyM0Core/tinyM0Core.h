...
/// Макрос WITH для удобного использования мьютексов.
/// Автоматически блокирует мьютекс в начале блока и разблокирует его в конце.
///
/// Пример использования:
/// WITH(&myMutex) {
///     // Критическая секция
///     // Код здесь выполняется, пока мьютекс заблокирован
/// }
///
/// @param mutex Указатель на мьютекс, который нужно использовать
